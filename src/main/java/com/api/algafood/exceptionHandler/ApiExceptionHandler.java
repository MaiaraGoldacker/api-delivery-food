...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler{
	...
	//Ao adicionar um tipo de retorno de imagem diferente do aceitável(png, jpeg), ele tentava dar o retorno do body na exception. O retorno do body era json, diferente do retorno da imagem solicitado. Isso estoura exception.
	@Override
	protected ResponseEntity<Object> handleHttpMediaTypeNotAcceptable(HttpMediaTypeNotAcceptableException ex,
			HttpHeaders headers, HttpStatus status, WebRequest request) {
		
		return ResponseEntity.status(status).headers(headers).build(); //retornarnando só o http status, sem body.
	}
	...
	//para tratar exceptions não tratadas!
	...
	public ResponseEntity<Object> handleUncaught(Exception ex, WebRequest request) {
	    ...
	    ex.printStackTrace(); //colocar para conseguir ver o erro durante o desenvolvimento
